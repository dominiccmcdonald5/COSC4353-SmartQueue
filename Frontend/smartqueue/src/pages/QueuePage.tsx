...
const QueuePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchQueueStatus = async () => {
      try {
        ...
        const response = await fetch(`https://cosc4353-smartqueue.onrender.com/api/queue/${concertId}${userIdParam}`);
  ...
  const handleJoinQueue = async () => {
    ...
    try {
      const res = await fetch('https://cosc4353-smartqueue.onrender.com/api/queue/join', {
        method: 'POST',
  ...
  const handleLeaveOtherQueueAndJoinThis = async () => {
    ...
    try {
      const leaveRes = await fetch('https://cosc4353-smartqueue.onrender.com/api/queue/leave', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
      ...
      const joinRes = await fetch('https://cosc4353-smartqueue.onrender.com/api/queue/join', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ concertId, userId: user.id }),
      });
  ...
  const handleLeaveQueue = async () => {
    ...
    try {
      const res = await fetch('https://cosc4353-smartqueue.onrender.com/api/queue/leave', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ concertId, userId: user.id }),
      });
